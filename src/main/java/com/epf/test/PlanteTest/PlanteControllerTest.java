...
public class PlanteControllerTest {
    ...
    public void testAddPlante() {
        ...
        ResponseEntity<Integer> response = planteController.addPlante(planteDTO);
    ...
    public void testUpdatePlante() {
        ...
        ResponseEntity<Integer> response = planteController.updatePlante(planteId, planteDTO);
    ...
    public void testDeletePlante() {
        ...
        ResponseEntity<Integer> response = planteController.deletePlante(planteId);
