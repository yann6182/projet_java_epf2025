...
public class PlanteControllerTest {
    ...
    public void testGetAllPlantes() {
        ...
        assertEquals(1, result.get(0).getIdPlante());
    ...
    public void testGetPlanteById() {
        ...
        assertNotNull(result);
        assertEquals(planteId, result.getIdPlante());
    ...
    public void testAddPlante() {
        ...
        planteDTO.setImage("tournesol.png");
    ...
    public void testUpdatePlante() {
        ...
        assertEquals(1, result);
        assertEquals(planteId, planteDTO.getIdPlante());  
